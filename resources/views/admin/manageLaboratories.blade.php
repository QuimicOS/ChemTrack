            ...
            <form id="laboratoryForm" novalidate>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="roomNumber"
                            placeholder="Enter room number (3-5 characters)" required>
                    </div>
                    <div class="col-md-6">
                        <label for="labName" class="form-label">Laboratory Name</label>
                        <input type="text" class="form-control" id="labName" placeholder="Enter laboratory name"
                            required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="professorInvestigator"
                            placeholder="Enter professor name" required>
                    </div>
                    <div class="col-md-6">
                        <label for="departmentDirector" class="form-label">Department Director</label>
                        <input type="text" class="form-control" id="departmentDirector"
                            placeholder="Enter department director name" required>
                    </div>
                </div>

                <!-- Submit Button -->
                <div class="text-end">
                    <button type="button" class="btn btn-success fw-bold" onclick="validateAndAddLab()" disabled>Add
                        Laboratory</button>
                </div>
            </form>
        </fieldset>
            ...
            <div class="row my-5">
                <div class="col-md-10">
                    ...
                    <input type="text" class="form-control" id="searchRoom"
                        placeholder="Search room number (3-5 characters)">
                </div>
...
@section('scripts')
    <script>
        ...
        function validateAddLabForm() {
            ...
            addLabButton.disabled = !(isDepartmentValid && isBuildingValid && isRoomValid && isLabNameValid &&
                isProfessorValid && isDepartmentDirectorValid);
        }
        ...
        //Function to save the changes that have been edited
        function saveEdit() {
